# Plan 01 — Postgres on Kubernetes, Exposed via Tailscale (Tailnet-Only)

<!-- renumbered 2026-05-31: was plan 02; promoted to 01 (already approved + deployable) per priority swap. -->
<!-- New plan 02 = infra/k8s + cloudflare tunnel; plan 03 = backend CQRS core (was 01). -->
